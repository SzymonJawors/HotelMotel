  ...
  return (
    <div className="flex flex-col items-center px-6 md:px-16 lg:px-24 bg-slate-50 py-20">
      <Title
        ...
        subTitle="Odkryj naszą starannie wyselekcjonowaną kolekcję wyjątkowych obiektów z całego świata, oferujących niezrównany luksus i niezapomniane doświadczenia."
      />
