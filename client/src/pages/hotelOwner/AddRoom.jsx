...
const AddRoom = () => {
  ...
  return (
    <form>
      ...
      <div className="w-full flex max-sm:flex-col sm:gap-4 mt-4">
        <div className="flex-1 max-w-48">
          ...
          >
            ...
            <option value="Pokój jednoosobowy">
              Pokój jednoosobowy
            </option>
            <option value="Pokój dwuosobowy">
              Pokój dwuosobowy
            </option>
            <option value="Luksusowy apartament">
              Luksusowy apartament
            </option>
            <option value="Apartament rodzinny">
              Apartament rodzinny
            </option>
          </select>
        </div>
      ...
      <button className="bg-primary text-white px-8 py-2 rounded mt-8 cursor-pointer">Dodaj pokój</button>
    </form>
  );
};
