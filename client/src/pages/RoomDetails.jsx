      ...
      <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
        ...
        <div className="flex flex-col md:flex-row md:justify-between mt-10">
          <div className="flex flex-col">
            <h1 className="text-3xl md:text-4xl font-playfair">
              Odkryj luksus w zupełnie nowym wymiarze.
            </h1>
        ...
        <div className="max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500">
          <p>
            Pokoje na parterze przydzielane są w miarę
            dostępności. Czeka na Was wygodny apartament z
            dwiema sypialniami o wyjątkowym, miejskim
            charakterze. Wyświetlona cena obejmuje pobyt
            dwóch osób - aby zobaczyć koszt dla całej grupy,
            prosimy wybrać właściwą liczbę gości w panelu
            rezerwacji.
          </p>
        </div>
